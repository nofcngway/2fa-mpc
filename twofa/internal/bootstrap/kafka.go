...
func NewKafkaProducer(brokers []string, topic string) twofaService.EventProducer {
...
func (p *KafkaProducer) PublishEvent(ctx context.Context, event twofaService.AuditEvent) error {
...
func (p *NoOpProducer) PublishEvent(_ context.Context, _ twofaService.AuditEvent) error {
	return nil
}
