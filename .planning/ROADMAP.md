...
Plans:
- [x] 04-01-PLAN.md — GF(256) finite field arithmetic with TDD (log/exp tables, add, mul, div, inv, 14 property tests)
- [x] 04-02-PLAN.md — Shamir Split/Combine with TDD (Share type, polynomial evaluation, Lagrange interpolation, 16+ tests)
...
- [x] 05-02-PLAN.md — GenerateProvisioningURI (otpauth:// URI) and URI format tests
...
### Phase 10: Refactoring — bootstrap split, slog logging, dependency inversion audit

**Goal:** Consistent bootstrap organization, centralized slog setup, and clean dependency inversion across all 3 services
**Requirements**: D-01 through D-11 (refactoring decisions from phase context)
**Depends on:** Phase 9
**Plans:** 3/3 plans complete

Plans:
- [x] 10-01-PLAN.md — TwoFA bootstrap split into per-component files + mpc_adapter.go rename
- [x] 10-02-PLAN.md — MPC bootstrap split into per-component files
- [x] 10-03-PLAN.md — slog extraction to bootstrap.NewLogger(), MPC shutdown fix, DI violations fix
...
| 10. Refactoring | 3/3 | Complete    | 2026-04-13 |

### Phase 11: Rename models to domain in MPC and TwoFA services, update documentation
