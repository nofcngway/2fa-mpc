...
type User struct {
	...
	UpdatedAt     string                 `protobuf:"bytes,5,opt,name=updated_at,json=updatedAt,proto3" json:"updated_at,omitempty"` // RFC 3339
...
const file_models_models_proto_rawDesc = "" +
	...
	"\rrefresh_token\x18\x02 \x01(\tR\frefreshTokenB2Z0github.com/vbncursed/vkr/auth/internal/pb/modelsb\x06proto3"
