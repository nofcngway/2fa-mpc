...
// Compile-time checks: KafkaProducer and NoOpProducer must implement authService.EventProducer.
var (
	_ authService.EventProducer = (*KafkaProducer)(nil)
	_ authService.EventProducer = (*NoOpProducer)(nil)
)
